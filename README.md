# ❗️ВНИМАНИЕ
Это **Proof-of-Concept**. Плагин написан с помощью ИИ-агентов, следовательно половина кода - слоп. Данный плагин сделан чтобы доказать возможность переноса работы запрета(zapret) на плагин систему Aroma.
...
2. **Кастомный DNS** — резолвит домены Pretendo через 8.8.8.8, обходя "отравленные" DNS провайдера
